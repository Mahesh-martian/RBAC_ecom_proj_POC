...
URL Source: https://sellercentral.amazon.com/help/hub/reference/external/G1701

Markdown Content:
As part of selling on the Amazon store, sellers communicate with buyers both directly and indirectly. Amazon requires that sellers follow the guidelines below for any communication with buyers. The Communication Guidelines policy is meant to protect buyers from fraud and abuse, and to protect you from unscrupulous actions from your competitors. Raising the bar for all communications to buyers benefits all our sellers, resulting in a stronger store.

## Direct communication

**Order status messages**

*   **Problem with order messages**: You must communicate with buyers if the ordered product is not available to be shipped. Firstly, adjust the full order amount using [Manage orders](https://sellercentral.amazon.com/orders-v3/search) or via an [Order Adjustment](https://sellercentral.amazon.com/gp/help/external/G200387280) feed. You must use NoInventory or CouldNotShip as the reason codes for the adjustment as necessary. Secondly, follow directions and select **Problem with order** to communicate with the buyer about your inability to fulfill the order. The message must contain a confirmation that the order amount was adjusted with the appropriate reason for the unavailability of the items. If you think you can fulfill the order but the shipment will be delayed beyond the advertized availability, you must notify the buyer about the delay. If the buyer decides to cancel the order, you must then start the refund process.

**Note:**If you're out of stock, don't contact the buyer to request that they submit a cancellation request.

*   **Return-related messages**: You must process refunds for the order amount (minus any charges) using either [Manage orders](https://sellercentral.amazon.com/orders-v3/search) or via an [Order Adjustment](https://sellercentral.amazon.com/gp/help/external/G200387280) feed. You may communicate with the buyer about the return only when you need additional information to complete the return or you are offering a partial refund. Follow directions and select **Follow-up on return request**.

## Buyer-Seller Messages

You may only send Permitted Messages to customers who have contacted you about purchasing a product or who have already bought a product from you on the Amazon store. We define Permitted Messages as those communications necessary to complete an order or to respond to a customer service inquiry.
...
You may send such proactive messages for the following reasons:
...
*   Any other reason where contact is required for the buyer to receive their order
...
For more information, visit Amazon’s guidelines in the [Customer product reviews policies](https://sellercentral.amazon.com/gp/help/external/GYRKB5RU3FS5TURN) help page.

To learn more, go to [Communicate with buyers using Buyer-Seller Messages](https://sellercentral.amazon.com/gp/help/external/G200389080).

## Indirect communication

Amazon communicates order-related information to buyers through **Your Account** updates. These updates include information, such as when an order has been shipped (with the tracking number) or when a refund has been processed. These updates are based on shipping confirmations and refunds initiated using [Manage orders](https://sellercentral.amazon.com/orders-v3/search) or the following feeds:
